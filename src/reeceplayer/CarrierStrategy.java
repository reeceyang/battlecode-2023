...
public class CarrierStrategy {
    ...
    static void runCarrier(RobotController rc) throws GameActionException {
        ...
        if (rc.canTakeAnchor(hqLoc, Anchor.STANDARD) && islandLoc != null) {
        ...
        if(anchorMode) {
            rc.setIndicatorString("anchor mode");
            ...
            rc.setIndicatorString("resource collection mode " + wellLoc);
...
//            System.out.print(well.getMapLocation());
//        }
//        System.out.println();
